 ...
 * ======================
 *
 * The previous four courses pasted code into the chapters and used this script
 * to check the paste still matched. Sextant's course reads the code out of the
 * project at build time instead, so *that* check is now vacuously true — the
 ...
 *
 * Run:  node sextant-course/verify.js
 */
 ...
 * either wrong or a parser. The lexer four directories away could do this
 * exactly — and using it would make this script depend on the project it is
 * checking, which is a loop worth avoiding for a heuristic.
 *
 * @param {string} text
 */
...
console.log(
	`${chapters.length} chapters · ${quoted} blocks quoted from sextant/ by line range · ` +
