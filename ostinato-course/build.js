 ...
 * prev/next links.
 *
 * The sixth course to use this builder. Code blocks carry the line range they
 ...
 *
 * Run:  node ostinato-course/build.js
 */
...
const COURSE = {
	name: 'Building Ostinato',
	subtitle: 'a Svelte 5 and SvelteKit 3 course',
	description:
		'Build a groovebox in the browser with Svelte 5 and SvelteKit 3 — a step sequencer with a real audio scheduler, synthesised drums and bass, shareable patterns, a gallery with vanity addresses, live jam rooms, an embeddable custom element and an adapter written from scratch.',
	lede: `A step sequencer, a synthesiser, a gallery, a jam room, an embeddable
		player and the adapter that deploys it — built from an empty folder, using
		every part of Svelte 5 and SvelteKit 3 that earns its place, including
		everything the September 2026 releases added. Every feature is used for
		something, explained from first principles, and tested end to end.`,
	badges: ['Svelte 5.57', 'SvelteKit 3', 'Web Audio', 'A custom adapter'],
	closing: `Every code block in this course is read out of the finished project
		in <code>ostinato</code> at build time — file and line numbers included — so
